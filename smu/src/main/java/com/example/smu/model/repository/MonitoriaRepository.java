...
public interface MonitoriaRepository extends JpaRepository<Monitoria,Integer> {
    ...
    WHERE m.id =: monitoriaid
    """) List<MonitoriaCurso> MateriaisPorMonitoria(@Param("monitoriaid") Integer monitoriaid);
    ...
    WHERE m.id =: monitoriaid
    """) List<MonitoriaCurso> SessoesPorMonitoria(@Param("monitoriaid") Integer monitoriaid);
